...
uint16_t W5100Class::write(uint16_t _addr, const uint8_t *_buf, uint16_t _len)
{
   ...
   // Initiating a transfer of length zero results                          //5-15-2014 JRS
   // in the interface crashing and becoming unresponsive.		    // this may have fixed a major crash issue when opening/closing web server repeatedly
   if( _len == 0 )
     return 0;
   //             
